...
void his_CAL_run617_250113()
{
	...
	*/
	...
	TH1D * his_tot3 = new TH1D("his_tot3","11det w/o 2, 4, 10",hisbin,0,4000);
	...
	for(int i=icheck; i<tot; i++){
	  ...
	  if(ifile==(fsub+1)){
	    ...
	    ftime=timesecleaf->GetValue();
	    icheck=i-1;
	    break;
	  }
	}

	cout<<"sel time : "<<ftime-itime<<endl;



	time_sec = ftime-itime;
	time_day = time_sec/(60*60*24);

	cout<<"sel total time : "<<time_sec<<" sec / "<<time_day<<" day"<<endl;
	*/
