...
//	sprintf(hisfile,"/data/HPGe/USERS/kkw/DAQ/ANA125/result/RUN%s/Bin%i/his_%s_2peak_rrs_on.root",runnumber3,binnum,runnumber6); 
	...
	sprintf(calfile,"/data/HPGe/USERS/kkw/DAQ/ANA125/result/RUN%s/Cal_v0/Cal_%s.v0.root",runnumber3,runnumber6); 
	sprintf(hisfile,"/data/HPGe/USERS/kkw/DAQ/ANA125/result/RUN%s/Bin%i/his_%s.v0.rrs_on.root",runnumber3,binnum,runnumber6); 
