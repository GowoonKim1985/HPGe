...
void fit_232Th()
{
	...
	ifstream peakdata1("/home/kkw/DAQ/ANA500/script/His_Fit_CODE/peak_232Th.dat");
	string line_n1;
	string line_n2;
	int line_max1 = 0;
	int line_max2 = 0;
	...
	ifstream peakdata2("/home/kkw/DAQ/ANA500/script/His_Fit_CODE/peak_232Th.dat");
	...
	TCanvas * div_peak = new TCanvas("fitting detail","fitting detail",1200,800);

	if(line_max1<=5){div_peak -> Divide(2,2);}
	if(line_max1<=7&&line_max1>5){div_peak -> Divide(3,2);}
	if(line_max1<=10&&line_max1>7){div_peak -> Divide(3,3);}
	...
	sprintf(hisfile,"/home/kkw/DAQ/ANA500/result/RUN%s/his_%s.root",runnumber3,runnumber6);
	sprintf(res2file,"/home/kkw/DAQ/ANA500/result/RUN%s/fit_232Th_%s.C",runnumber3,runnumber6);
	sprintf(res3file,"/home/kkw/DAQ/ANA500/result/RUN%s/fit_232Th_%s.root",runnumber3,runnumber6);
	...
	cout<<"test1"<<endl;
	sprintf(rawhis[0],"his%i",1);
	cout<<rawhis[0]<<endl;
	//his_temp = (TH1D*)hf->Get(rawhis[0]);
...
*/
		...
		*/
		...
		his_temp->SetTitle("232Th Fitting");
