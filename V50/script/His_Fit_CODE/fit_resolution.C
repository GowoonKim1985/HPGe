...
void fit_resolution() {
	...
	char iso[256];
	sprintf(iso, "./peak/peak_source.dat");
	...
	if(evt_case==0){
		...
		sprintf(hisfile, "/home/kkw/DAQ/ANA500/result/RUN%d/his_%s_M%i.root", runnum, runnumber, evt_case);
		sprintf(res2file, "/home/kkw/DAQ/ANA500/result/RUN%d/M%i_spectrum.C", runnum, evt_case);
		sprintf(res3file, "/home/kkw/DAQ/ANA500/result/RUN%d/res_%s_M%i.root", runnum, runnumber, evt_case);
	}
