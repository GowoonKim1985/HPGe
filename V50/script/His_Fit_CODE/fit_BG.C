...
*/
	...
	sprintf(res2file,"%s/result/RUN%s/Bin%i/fit_BG_%s.C", workdir.c_str(), runnumber3,binnum,runnumber6);
	sprintf(res3file,"%s/result/RUN%s/Bin%i/fit_BG_%s.root", workdir.c_str(), runnumber3,binnum,runnumber6);
