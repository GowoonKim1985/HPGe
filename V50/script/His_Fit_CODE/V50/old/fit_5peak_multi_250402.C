...
void fit_5peak_multi_250402()
{
	...
	//	double peakfix[N] = {768.2, 771.402, 783.3, 786.3, 795.55};//peak 5, v1 new cal
	double peakfix[N] = {768.309, 772.26, 783.25, 785.908, 795.0}; //run650 v1
	...
	//General resolution
		double respa[3];//new cal. sigma = sqrt(a*a + b*E + c*E*E)
	respa[0] = 0.446;
	respa[1] = 6.06e-4;
	respa[2] = -6.31e-8;
...
//	  fit->FixParameter(8, sigma_cal[2]);
	...
	fit->SetParLimits(10,peak[2]-0.2, peak[2]+0.3);
	fit->FixParameter(11,sigma_cal[2]);
