...
TF1 *fit = new TF1("fit", formula);
	...
	//6 peaks
	fitpara -> Branch("pol0", &fitpa[15], "fitpa[18]/D");
	fitpara -> Branch("pol1", &fitpa[16], "fitpa[19]/D");

	fitpara -> Branch("pol0_err", &fiter[15], "fitper[18]/D");
	fitpara -> Branch("pol1_err", &fiter[16], "fitper[19]/D");
