...
void draw_run624_check() {
  ...
  /*
  //old cal set
  double x[dp] = {6.09126e+02,  9.11054e+02, 1.12001e+03};
  double ex[dp] = {2.18868e-02, 9.11295e-02, 5.09417e-02};
  double y[dp] = { 8.52464e-01 ,  1.02395e+00, 9.33861e-01};
  double ey[dp] = {2.35830e-02, 1.19865e-01, 5.67681e-02};
  */
  
  //new cal set v1
  double x[dp] = { 6.09800e+02,  9.11908e+02, 1.12109e+03  };
  double ex[dp] = { 2.21789e-02 , 6.95734e-02,  5.23144e-02};
  double y[dp] = { 7.52892e-01,  9.44904e-01,9.48750e-01 };
  double ey[dp] = { 2.16650e-02 ,8.20595e-02, 5.55943e-02 };
