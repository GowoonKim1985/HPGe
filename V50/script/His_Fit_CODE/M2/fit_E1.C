...
void fit_E1()
{
	...
	sprintf(peakfile,"/home/kkw/DAQ/ANA500/script/His_Fit_CODE/peak_R%03d/peak_E1_%s.dat",runnum, hist_check1);
...
//	m3fitpara ->Branch("pcount_er",&m3pcnter,"m3pcnter/D");
	...
	sprintf(hist_check_fin,"%s_E1_1dim",hist_check1);

	sprintf(hisfile,"/home/kkw/DAQ/ANA500/result/RUN%s/Bin%i/his_%s_M2.root",runnumber3,binnum,runnumber6);
	sprintf(res2file,"/home/kkw/DAQ/ANA500/result/RUN%s/Bin%i/fit_%s_E1_%s.C",runnumber3,binnum,hist_check1,runnumber6);
	sprintf(res3file,"/home/kkw/DAQ/ANA500/result/RUN%s/Bin%i/fit_%s_E1_%s.root",runnumber3,binnum,hist_check1,runnumber6);
