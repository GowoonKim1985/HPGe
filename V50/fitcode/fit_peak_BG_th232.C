...
//	scanf("%s", nuname);
	...
	*/
	...
	if(bgnum==2){
	  sprintf(hisfile,"%s/result/V50/Bin%i/his_000657.v1.root", workdir.c_str(), binnum);
	  sprintf(res2file,"%s/result/V50/Bin%i/fit_000657.v1.232Th.C", workdir.c_str(), binnum);
	  sprintf(res3file,"%s/result/V50/Bin%i/fit_000657.v1.232Th.root", workdir.c_str(), binnum);
	}
