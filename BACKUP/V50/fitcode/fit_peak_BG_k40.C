...
//	scanf("%s", nuname);
	...
	*/
	...
	if(bgnum==2){
	  ...
	  sprintf(res2file,"%s/result/V50/Bin%i/fit_000657.v1.40K.C", workdir.c_str(), binnum);
	  sprintf(res3file,"%s/result/V50/Bin%i/fit_000657.v1.40K.root", workdir.c_str(), binnum);
	}
