...
//	scanf("%s", nuname);
	...
	sprintf(peakfile,"%s/script/His_Fit_CODE/V50/peak/peak_40K.dat", workdir.c_str());
	...
	*/
	...
	if(expnum==1){
	  ...
	  sprintf(res2file,"%s/result/V50/Bin%i/fit_000624.v0.rrs_on_40K.C", workdir.c_str(), binnum);
	  sprintf(res3file,"%s/result/V50/Bin%i/fit_000624_v0.rrs_on_40K.root", workdir.c_str(), binnum);
	}
	
	if(expnum==2){
	  sprintf(hisfile,"%s/result/V50/Bin%i/his_000650.v1.root", workdir.c_str(), binnum);
	  sprintf(res2file,"%s/result/V50/Bin%i/fit_000650.v1_40K.C", workdir.c_str(), binnum);
	  sprintf(res3file,"%s/result/V50/Bin%i/fit_000650.v1_40K.root", workdir.c_str(), binnum);

	  /*	  sprintf(hisfile,"%s/result/V50/Bin%i/his_000650.v1cut.root", workdir.c_str(), binnum);
	  sprintf(res2file,"%s/result/V50/Bin%i/fit_000650.v1cut_40K.C", workdir.c_str(), binnum);
	  sprintf(res3file,"%s/result/V50/Bin%i/fit_000650.v1cut_40K.root", workdir.c_str(), binnum);
	  */
