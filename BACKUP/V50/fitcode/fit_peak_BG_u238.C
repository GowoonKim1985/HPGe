...
//	scanf("%s", nuname);
	...
	*/
	...
	if(bgnum==2){
	  ...
	  sprintf(res2file,"%s/result/V50/Bin%i/fit_000657.v1.238U.C", workdir.c_str(), binnum);
	  sprintf(res3file,"%s/result/V50/Bin%i/fit_000657.v1.238U.root", workdir.c_str(), binnum);
	}
